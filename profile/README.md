...
Open-source products for Zi Wei Dou Shu, AI-guided reflection, and Eastern archetype exploration.

## Product Ecosystem

| Product | What it helps with | Explore |
| --- | --- | --- |
...
Ziwei Knows was founded and is primarily developed by [Jay Feng (@ruijayfeng)](https://github.com/ruijayfeng), an AI product manager focused on trustworthy AI experiences, structured domain knowledge, and approachable consumer tools.

## Open Source

Every repository includes its own setup, deployment, contribution, and license information. Stars, issues, pull requests, and substantive feedback help the products improve.